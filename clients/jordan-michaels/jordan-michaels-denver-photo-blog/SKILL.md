---
name: jordan-michaels-denver-photo-blog
description: >
  Write SEO and AEO optimized blog posts for Jordan Michaels Studio, a headshot and personal
  branding photographer in Denver, CO (RiNo studio). Sessions are in-studio only -- never
  on-location or outdoor. Use this skill whenever the client asks to write a blog post, generate
  photography content, draft an article, or check for duplicate topics. Trigger on: "write a blog
  post", "generate a blog", "write about headshots", "check for dupes", "Denver headshot blog",
  "Jordan Michaels blog", "actor headshots", "LinkedIn headshots", "studio team headshots",
  "city expansion blog", or any time the client wants to publish to their website or track a post.
  Always use this skill -- do not freeform it.
compatibility: "Requires Notion MCP"
---

# Jordan Michaels Studio Blog Skill

Write location-specific, audience-specific, SEO and AEO optimized blog posts for
Jordan Michaels Studio. Every post targets a specific metro audience and geography.
...
1. Load client-profile.md. Collect topic, keyword, audience/city; determine pillar vs. cluster (Step 1)
...
|---|---|
| "What to Wear for a Headshot" | "What Denver Executives Should Wear — Studio vs. On-Location" |
| "Benefits of Conference Headshots" | "Why Denver Conference Attendees Love Professional Headshot Booths" |
| "Personal Branding Tips" | "How Denver Entrepreneurs Use Personal Branding Photos to Build Trust" |
